...
class M4C(BaseModel):
    def __init__(self, config):
        ...
        self.cls_embbed = np.load('./VG_sg_features/ft_cls_embbed.npy', allow_pickle=True)
    ...
    def _build_obj_encoding(self):
        ...
        # ADD 14/1/2022
        # self.obj_cls_layer_norm = BertLayerNorm(self.mmt_config.hidden_size)
        # self.linear_obj_class_to_mmt_in = nn.Linear(
        ...
        # # 16/1/2022 THU NGHIEM HUONG MULTIHEAD ATTENTION

        # self.mulhead_att = nn.MultiheadAttention(self.mmt_config.hidden_size, num_heads=3, dropout=0.1, bias=True)
        # self.att_layer_norm = BertLayerNorm(self.mmt_config.hidden_size)
    ...
    def _forward_obj_encoding(self, sample_list, fwd_results):
        ...
        # create mulhead mask
        mask_combined_feat = obj_bbox.sum(dim=2) != 0 # [bs, 100]
        ...
        obj_mmt_in = (
            ...
            # self.obj_cls_layer_norm(self.linear_obj_class_to_mmt_in(obj_cls_feature.type(torch.float32)))
            # self.r50_layer_norm(self.linear_r50_to_mmt_in(obj_feat_r50_2048.type(torch.float32)))
        ...
        fwd_results['obj_mask'] = mask_combined_feat
    ...
    def _forward_ocr_encoding(self, sample_list, fwd_results):
        ...
        # ocr_relative_geometry = relative_geometry_weights[0][0]
